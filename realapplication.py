...
#from usrnet.models.network_usrnet import USRNet as net  # for pytorch version <= 1.7.1
from usrnet.models.network_usrnet_v1 import USRNet as net  # for pytorch version >= 1.8.1
...
class Worker:
    def __init__(self, fallback=False):
        ...
        self.model_pool = 'usrnet/model_zoo'
    ...
    def rock(self, img, E_path, noiseLevel, sf, customized_kernel_width=False):  # orig img full path
        sf = int(sf)
